...
def cache_checkout_data(request):
    try:
        pid = request.POST.get('client_secret').split('_secret')[0]  # Payment intent Id variable
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            # Saves the info to the user's profile if the process worked correctly
        ...
        # Tries to fill the form if the user has any saved information in his profile
