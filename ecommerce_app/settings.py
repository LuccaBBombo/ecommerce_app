...
ALLOWED_HOSTS = ['eletrohome.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    # Cache time expire control
    AWS_S3_OBJECT_PARAMETERS = {
        'Expires': 'Thu, 31 Dec 2099 20:00:00 GMT',
        'CacheControl': 'max-age=94608000',
    }
    # Bucket Configuration for Heroku
    AWS_STORAGE_BUCKET_NAME = 'eletrohomr'
...
DEFAULT_FROM_EMAIL = 'eletrohome@example.com'
